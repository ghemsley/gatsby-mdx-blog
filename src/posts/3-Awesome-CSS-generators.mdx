...
First you use their graphical tool to define the flex attributes for a parent component that is going to hold some child comonents you want help with laying out properly. 
...
![CSS Grid Layout Generator](../assets/images/posts/3-awesome-css-generators/grid-generator.jpg)
 ...
 If you're anything like me, trying to use CSS Grid normally is a surefire way to melt your brain. This tool changes that, although even with the tool I *still* end up with a bit of brain melt going on sometimes. But for visualizing the shape of that which torments me, I find there is no better tool. Really! I have tried a lot of CSS Grid generators, this one is one of the most complete ones out there (although some with less features may be a little simpler to get started with). 
