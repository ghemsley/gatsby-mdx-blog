...
I had other problems though. What to build? And if meeting the requirements is a 100% effort, how could I give 110% this time?
...
## Attempting to achieve 110%

I guess my default for these projects has become to look at what is expected, then see how I can bend the rules towards a shape that will allow me to at once maximally learn and grow as a student and developer, have a stupid amount of fun building something, and still check all the boxes of having done what is required, or hopefully a little more. I am so very thankful for the flexibility of my school's instructors and curriculum so far, because it has allowed me to really flex my humble muscles of creativity through these projects in ways that have been very gratifying, without ill effect on my project score. In fact, it has felt as if I have even been rewarded for doing so, which is partly what earns my school the heaps of praise I have for it as an educational institution. (I love my school!)

That is all to say that for this project, I am back to my old ways of bending the rules a little (or perhaps a lot). We will see how far the girders of my school's curriculum structure will flex this time, but hopefully I have at least met the core expectations again.
