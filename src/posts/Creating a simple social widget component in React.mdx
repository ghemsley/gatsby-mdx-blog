...
### An example of our component

<div style={{ background: "#153259", padding: '16px', borderRadius: '8px', maxWidth: 'fit-content', margin: '32px', transform: 'scale(1.25)' }}>
  <Social iconSize={40} />
</div>

And there you have it! A nice little social widget thingy. I hope you found this helpful somehow!
